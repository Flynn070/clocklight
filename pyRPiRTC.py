...
class DS1302:
    ...
    def __init__(self, clk_pin=19, data_pin=18, ce_pin=17):
        # init GPIO
        # no warnings
        ...
        GPIO.setup(self._clk_pin, GPIO.OUT, GPIO.LOW)
        GPIO.setup(self._ce_pin, GPIO.OUT, GPIO.LOW)
